...
export const withSecurityHeaders = (
  ...
  const defaultCSP = [
    ...
    "font-src 'self' data:",
    "connect-src 'self' https://us.i.posthog.com https://us-assets.i.posthog.com https://www.google-analytics.com https://www.googletagmanager.com https://*.ably.io https://*.ably-realtime.com https://*.ably.net wss://*.ably.io wss://*.ably-realtime.com wss://*.ably.net https://*.r2.cloudflarestorage.com https://api.knock.app wss://api.knock.app",
    "frame-src 'self'",
    "object-src 'none'",
    "base-uri 'self'",
    "form-action 'self'",
