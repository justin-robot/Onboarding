            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                ...
                <Button
                  ...
                  variant="outline"
                  size="icon"
                  onClick={() => validateAndAddEmail(emailInput)}
              ...
              <FormDescription>
                {inviteEmails.length === 0
                  ? "Add email addresses to invite. Press Enter or click + to add."
                  : `${inviteEmails.length} invitation${inviteEmails.length > 1 ? "s" : ""} will be sent when you publish.`
                }
              </FormDescription>
            </div>
